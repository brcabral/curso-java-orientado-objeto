...
System.out.println(">>> pagamento de conta pendente (ok, deve funcionar)");  //retirar
        conta1.pagar();
System.out.println(); //retirar

        // tentativa de pagar uma conta cancelada (não deve aceitar pagamento)
System.out.println(">>> tentativa de pagar uma conta cancelada (não deve aceitar pagamento)"); // retirar
        conta2.cancelar();
        conta2.pagar();
System.out.println(); // retirar

        // tentativa de pagar uma conta duas vezes (não deve aceitar na segunda vez)
System.out.println(">>> tentativa de pagar uma conta duas vezes (não deve aceitar na segunda vez)");
        conta3.pagar();
        conta3.pagar();
    }
}
